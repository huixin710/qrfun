            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-12 mx-auto" style="border:3px #696969 solid;">
                        ...
                        <?php
                        echo "<form class='custom-form contact-form' method='POST' action='register_action_admin.php?appmail=$appmail'>";
                        ?>
                        ...
                        <div class="row" style="border-top-style:2px #696969 solid; ">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <label for="first-name">單位</label>

                                <input type="text" name="department" class="form-control" placeholder="請輸入您的單位" required>
                            </div>
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-6 mx-auto text-center">
                                    <button type="submit" name="b1" class="form-control" value="sent">註冊</button>
