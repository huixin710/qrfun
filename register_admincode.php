                    ...
                    <form class="custom-form contact-form" action="" method="post" role="form">
                        ...
                        <div class="row" style="border-top-style:2px #696969 solid; ">
                            <div class="col-lg-12 col-md-12 col-12">
                                <label for="first-name">驗證碼</label>

                                <input type="text" name="code" class="form-control" placeholder="請輸入您的驗證碼" required>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-6 mx-auto text-center">
                            ...
                            <button type="submit" class="form-control text-black" name="subcode">送出驗證信</button>
                            <br>
                        </div>
                </div>
            </div>
