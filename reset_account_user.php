                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 col-12 mx-auto" style="border:3px #696969 solid;">
                        <form class="custom-form contact-form" action="" method="post" role="form">
                            <h4 class="text-center mb-4" style="border-bottom-style: 2px  #696969 solid;">忘記帳號</h4>

                            <div class="row" style="border-top-style:2px #696969 solid; ">
                                <div class="col-lg-12 col-md-12 col-12">
                                    <label for="first-name">電子郵件</label>
                                    <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="請輸入您的電子郵件找回帳號" required>
                                </div>
...
if (isset($_POST["submail"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        try {
            ...
            $mail->Subject = "Retrieve your account";
            $mail->Body    = "您的帳號是：$uidd<br>請點擊以下網址進行郵件驗證：<a href='125.229.13.233/login_user.php'>125.229.13.233/login_user.php</a>";
...
?>
            <script language="JavaScript">
                ...
                window.location.href = 'reset_account_form.php?mail=<?php echo $email; ?>';
            </script>
        <?php
        } catch (Exception $e) {
